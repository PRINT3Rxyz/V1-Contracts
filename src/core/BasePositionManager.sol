...
contract BasePositionManager is IBasePositionManager, ReentrancyGuard, Governable {
    ...
    constructor(address _vault, address _router, address _shortsTracker, address _weth, uint256 _depositFee) {
        vault = _vault;
        router = _router;
        weth = _weth;
    ...
    function _decreasePosition(
        ...
        IShortsTracker(shortsTracker).updateGlobalShortData(
            _account, _collateralToken, _indexToken, _isLong, _sizeDelta, markPrice, false
        );
