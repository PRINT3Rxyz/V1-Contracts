...
contract RouterTest is Test {
    ...
    */
    ...
    function testRouterSwapEthToTokens() public giveUserCurrency {
        ...
        address[] memory _path = wethToUsdcArray;
        uint256 usdcBalBefore = Token(usdc).balanceOf(USER);
        router.swapETHToTokens{value: 1e18}(_path, 0, USER);
        uint256 usdcBalAfter = Token(usdc).balanceOf(USER);
        assertGt(usdcBalAfter, usdcBalBefore);
        vm.stopPrank();
    }
    ...
    function testRouterIncreasePosition() public giveUserCurrency {
        ...
        router.increasePosition(
            _path, weth, 1e19, 0, 35689554309499200000000000000000000, true, 2661587547909500000000000000000000
        );
        vm.stopPrank();
        boolArray.push(true);
        bool[] memory _isLong = boolArray;
        uint256[] memory returnArray = reader.getPositions(address(vault), USER, _path, _path, _isLong);
    ...
    function testRouterIncreasePositionEth() public giveUserCurrency {
        ...
        router.increasePositionETH{value: 1e19}(
            _path, weth, 0, 35689554309499200000000000000000000, true, 2661587547909500000000000000000000
        );
        vm.stopPrank();
        boolArray.push(true);
        bool[] memory _isLong = boolArray;
    ...
    function testRouterDecreasePosition() public giveUserCurrency {
        ...
        router.increasePosition(
            _path, wbtc, 1e8, 0, 35689554309499200000000000000000000, true, 31276847840000000000000000000000000
        );
        boolArray.push(true);
        bool[] memory _isLong = boolArray;
        uint256[] memory startPosition = reader.getPositions(address(vault), USER, _path, _path, _isLong);
        ...
        uint256[] memory endPosition = reader.getPositions(address(vault), USER, _path, _path, _isLong);
    ...
    function testRouterDecreasePositionETH() public giveUserCurrency {
        ...
        WETH(weth).increaseAllowance(address(router), LARGE_AMOUNT);
        router.increasePosition(
            _path, weth, 1e18, 0, 35689554309499200000000000000000000, true, 31276847840000000000000000000000000
        );
        boolArray.push(true);
        bool[] memory _isLong = boolArray;
        uint256[] memory position = reader.getPositions(address(vault), USER, _path, _path, _isLong);
    ...
    function testRouterDecreasePositionAndSwap() public giveUserCurrency {
        ...
        WETH(weth).increaseAllowance(address(router), LARGE_AMOUNT);
        router.increasePosition(
            _path, wbtc, 1e18, 0, 35689554309499200000000000000000000, true, 31276847840000000000000000000000000
        );
        boolArray.push(true);
        bool[] memory _isLong = boolArray;
        wbtcArray.push(wbtc);
        address[] memory _token = wbtcArray;
        uint256[] memory startPosition = reader.getPositions(address(vault), USER, _token, _token, _isLong);
        assertGt(startPosition[0], 0);
        // Close the long position
        wbtcToUsdcArray.push(wbtc);
        wbtcToUsdcArray.push(usdc);
        address[] memory _path2 = wbtcToUsdcArray;
        uint256 usdcBalBefore = Token(usdc).balanceOf(USER);
    ...
    function testRouterDecreasePositionAndSwapEth() public giveUserCurrency {
        ...
        address[] memory _path2 = wbtcToWethArray;
        uint256 balBefore = address(USER).balance;
