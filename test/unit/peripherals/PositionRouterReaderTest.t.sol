...
contract PositionRouterReaderTest is Test {
    ...
    Reader reader;
    PositionRouterReader positionRouterReader;
    ...
    function setUp() public {
        ...
        positionRouterReader = new PositionRouterReader();
    ...
    function testPositionRouterReaderGetTransferTokenOfIncreasePositionRequests()
        public
        giveUserCurrency
        returns (uint256[] memory requestIndexes, address[] memory transferTokens)
    {
        // Create some increase position requests
        wbtcArray.push(wbtc);
        ...
        positionRouter.createIncreasePosition{value: 300000000000000}(
            _path,
            address(wbtc),
            1e8,
            0,
        ...
        (requestIndexes, transferTokens) =
            positionRouterReader.getTransferTokenOfIncreasePositionRequests(address(positionRouter), 1);
        assertEq(transferTokens[0], wbtc);
    }
}
