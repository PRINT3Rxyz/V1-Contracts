...
ifeq ($(findstring --network tbase,$(ARGS)),--network tbase)
	NETWORK_ARGS := --rpc-url $(TBASE_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
